...
import { ProjectiveInfo } from "@/lib/types"
import { motion } from "framer-motion"
import { useRef } from "react"

type ProjectiveProps = ProjectInfo;
...
export default function Project({
  ...
  return (
    ...
    className="group mb-3 sm:mb-8 last:mb-0">
      <section className="bg-white max-w-[42rem] border border-black-5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:grounp-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
