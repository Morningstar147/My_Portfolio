...
const HamburgerMenu: React.FC<HamburgerMenuProps> = ({ links }) => {
  ...
  return (
    <div className="md:hidden top-5 right-5 fixed w-60 z-[999] flex flex-col items-end gap-2">
      ...
      whileTap="tap"
      whileHover="hover"
      className="bg-white w-[3rem] drop-shadow
      backdrop-blur-[0.5rem] border border-slate-400 dark:border-white border-opacity-40 shadow-2xl rounded-full flex items-center justify- center dark:bg-gray-950"
      >
                  ...
                  >
                    {links.map((link, index) => (
                      ...
                      >
                        <NextLink
                        className={clsx(
                          "flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transitione dark:hover:text-gray-300 cursor-pointer",
                          {
